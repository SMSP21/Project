    ...
    export default function Collections() {
      return (
        ...
        <h1 className="text-3xl font-medium font-mulish mb-4 text-center pt-4 text-black mb: pt-10">Collections</h1>
            <div className="flex flex-col space-y-4 mx-2 pb-16 md:mx-4 lg:mx-4 xl:mx-20">
              ...
              {/* First image group */}
              <div className="flex flex-col lg:flex-row h-auto lg:h-[900px] space-y-4 lg:space-y-0 lg:space-x-2">
              {/* Images */}
      <div className="lg:w-1/2 pr-4 bg-white-700 h-[400px] lg:h-full pl-4 pt-4">
      ...
      <div className="lg:w-1/2 bg-white-400 h-auto lg:h-full flex flex-col">
        <div className="w-full bg-white-200 h-auto lg:h-1/2 flex flex-row space-x-4 p-2">
        ...
        <div className="w-full bg-white-300 h-auto lg:h-1/2 flex flex-row space-x-2 p-2 mt-4 lg:mt-0">
          <div className="relative group bg-white-300 p-2 w-1/2">
            <div className="relative h-[250px] lg:h-full">
          ...
          <div className="relative group bg-white-400 p-2 w-1/2">
            ...
            {/* Second image group */}
        {/* Second image group */}
    <div className="flex flex-col lg:flex-row h-auto lg:h-[900px] space-y-4 lg:space-y-0 lg:space-x-4 pt-5">
      <div className="lg:w-1/2 bg-white-400 h-auto lg:h-full flex flex-col space-y-4">
        <div className="w-full bg-white-200 h-[300px] lg:h-1/2 flex flex-row space-x-4 p-2">
          <div className="relative group bg-white-100 p-2 w-1/2">
        ...
        <div className="w-full bg-white-300 h-[300px] lg:h-1/2 flex flex-row space-x-4 p-2">
          <div className="relative group bg-white-300 p-2 w-1/2">
            <div className="relative h-full">
    ...
    <div className="flex flex-col lg:flex-row h-auto lg:h-[900px] space-y-4 lg:space-y-0 lg:space-x-4 pt-5">
      <div className="lg:w-1/2 bg-white-400 h-auto lg:h-full flex flex-col space-y-4">
        <div className="w-full bg-white-200 h-[300px] lg:h-1/2 flex flex-row space-x-4 p-2 pt-4">
    ...
    <div className="flex flex-col lg:flex-row h-auto lg:h-[900px] space-y-4 lg:space-y-0 lg:space-x-4 pt-5">
      ...
      <div className="lg:w-1/2 bg-white-400 h-auto lg:h-full flex flex-col space-y-4">
        <div className="w-full bg-white-200 h-[300px] lg:h-1/2 flex flex-row space-x-4 p-2 pt-2">
          <div className="relative group bg-white-100 p-2 w-full">
            <div className="relative h-full">
    ...
    <div className="flex flex-col lg:flex-row h-auto lg:h-[900px] space-y-4 lg:space-y-0 lg:space-x-4 pt-5">
      ...
      <div className="lg:w-1/2 bg-white-400 h-[440px] lg:h-[440px] flex flex-col">
        <div className="w-full bg-white-200 h-[440px] lg:h-[440px] flex flex-row space-x-4 p-2">
          <div className="relative group bg-white-100 p-2 w-full">
            <div className="relative h-full">
